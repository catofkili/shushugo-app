...
1. Git 历史与旧项目文档确认，当前 10,609 条 JLPT 词条、中文释义和原例句来自 [eggrolls-JLPT10k-v3.5](https://github.com/5mdld/anki-jlpt-decks)，适用 CC BY-NC 4.0。上游明确禁止将内容整合进付费产品或服务，因此当前词库不能直接商用。
...
| JLPT 例句 | `frontend/src/data/jlpt_words_seed.json`、`frontend/public/nihongo.db` | DB 有 10,993 条日文例句：9,932 条仍含已确认上游例句文本或连续片段；其中 2,931 条只改标点、4,631 条主要加了「私は」；另有 394 条例句来源无法确认；7,558 条中文翻译未改变 | 不能按现状商用；重新从无上游例句的输入独立创作并审校，或取得商业授权 |
