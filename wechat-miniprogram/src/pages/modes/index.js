Page({
  data: {
    modes: [
      ...
      { title: '错题本', detail: '集中复习曾经忘记或记得模糊的词', url: '/pages/index/index?mode=mistakes', tone: 'red' },
      { title: '反向回忆', detail: '中文 → 日语；单独记录这一方向的掌握程度', url: '/pages/index/index?direction=reverse', tone: 'purple' },
